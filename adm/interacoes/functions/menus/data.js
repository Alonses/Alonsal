...
module.exports = async ({ client, user, interaction, dados }) => {
    ...
    const row = client.create_buttons([{ id: "data_confirm_button", name: client.tls.phrase(user, "menu.botoes.confirmar"), value: '0', emoji: client.emoji(10), type: 2, data: `1.${escolha}` }, { id: "data_confirm_button", name: client.tls.phrase(user, "menu.botoes.cancelar"), value: '0', type: 3, emoji: client.emoji(0), data: '0' }, { id: "return_button", name: client.tls.phrase(user, "menu.botoes.retornar"), value: '1', type: 0, emoji: client.emoji(19), data: `data.${escolha}` }], interaction)
