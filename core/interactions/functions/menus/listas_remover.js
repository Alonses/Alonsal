...
module.exports = async ({ client, user, interaction, dados, autor_original }) => {
    ...
    const row = client.create_buttons([
        { id: "return_button", name: { tls: "menu.botoes.retornar" }, type: 0, emoji: client.emoji(19), data: "listas_remover" },
        { id: "tasks_delete_list", name: { tls: "menu.botoes.apagar" }, type: 3, emoji: client.emoji(13), data: `1|${lista_timestamp}` },
        { id: "tasks_delete_list", name: { tls: "menu.botoes.cancelar" }, type: 1, emoji: client.emoji(0), data: 0 }
    ], interaction, user)
