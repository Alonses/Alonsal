...
module.exports = async ({ client, user, interaction, dados, pagina }) => {
    ...
    if (operacao === 1) {
        ...
        const data = {
            ...
            operation: operacao,
            values: await client.getGuildChannels(interaction, user, ChannelType.GuildCategory, client.decifer(guild.tickets.category))
        }
        ...
        let botoes = [
            ...
            { id: "guild_tickets_button", name: { tls: "menu.botoes.atualizar", alvo: user }, type: 1, emoji: client.emoji(42), data: "2" }
        ]
