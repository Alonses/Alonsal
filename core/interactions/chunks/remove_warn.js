...
module.exports = async ({ client, user, interaction, dados }) => {
    ...
    const row = client.create_buttons([
        ...
        { id: "warn_remove_user", name: { tls: "menu.botoes.confirmar" }, type: 1, emoji: client.emoji(10), data: `1|${id_alvo}.${id_guild}` },
        { id: "warn_remove_user", name: { tls: "menu.botoes.cancelar" }, type: 3, emoji: client.emoji(0), data: `0|${id_alvo}.${id_guild}` }
    ], interaction, user)
