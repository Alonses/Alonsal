...
module.exports = async ({ client, user, interaction, pagina_guia }) => {
    ...
    if (pagina === 0)
        ...
        botoes = botoes.concat([
            ...
            { id: "guild_anti_spam_button", name: "Menções", type: type_button(guild?.spam.notify), emoji: emoji_button(guild?.spam.notify), data: "7" },
