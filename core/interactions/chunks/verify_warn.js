...
module.exports = async ({ client, user, interaction, dados }) => {
    ...
    let botoes = [
        { id: "return_button", name: { tls: "menu.botoes.retornar" }, type: 0, emoji: client.emoji(19), data: `warn_browse_user|${pagina}` },
        { id: "warn_remove_user", name: { tls: "menu.botoes.remover_advertencias" }, type: 1, emoji: client.emoji(42), data: `2|${id_alvo}.${interaction.guild.id}` },
