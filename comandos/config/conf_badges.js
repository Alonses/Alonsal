...
module.exports = {
    ...
    async execute(client, user, interaction) {
        ...
        if (!all_badges.includes(badge_alvo)) {
            ...
            const row = client.create_buttons([{ id: "badges", name: client.tls.phrase(user, "menu.botoes.confirmar_notificando"), value: '1', type: 2, data: `1|${id_alvo}.${badge_alvo}` }, { id: "badges", name: client.tls.phrase(user, "menu.botoes.apenas_confirmar"), value: '0', type: 1, data: `2|${id_alvo}.${badge_alvo}` }, { id: "badges", name: client.tls.phrase(user, "menu.botoes.cancelar"), value: '0', type: 3, emoji: '🛑', data: 0 }], interaction)
