module.exports = {
    ...
    async execute(client, message, args) {
        ...
        if(!message.member.permissions.has("ADMINISTRATOR") && !client.owners.contains(message.author.id)) return message.reply(":octagonal_sign: | "+ moderacao[5]["moderadores"]); // Libera configuração para o proprietários e adms apenas
