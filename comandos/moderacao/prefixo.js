module.exports = {
    ...
    async execute(client, message, args) {
        ...
        client.prefixManager.setPrefix(message.guild.id, args[0].raw)
        message.reply(`:asterisk: | ${moderacao[5]["att_prefix"]} \`${args[0].raw}\``);
        
        client.channels.cache.get('872865396200452127').send(`:asterisk: | Prefixo do servidor ( \`${message.guild.name}\` | \`${message.guild.id}\` ) alterado para : \`${args[0].raw}\``);
    }
};