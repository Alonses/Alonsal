...
module.exports = {
    ...
    async execute(client, user, interaction) {
        ...
        const row = client.create_buttons([{ id: "custom_color", name: client.tls.phrase(user, "menu.botoes.confirmar"), value: '1', type: 2, data: `1|${entrada}${new_color}` }, { id: "custom_color", name: client.tls.phrase(user, "menu.botoes.cancelar"), value: '0', type: 3, emoji: client.emoji(0), data: 0 }], interaction)
