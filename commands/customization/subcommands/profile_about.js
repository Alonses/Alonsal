module.exports = async ({ client, user, interaction }) => {
    ...
    const row = client.create_buttons([
        { id: "user_profile_about", name: { tls: "menu.botoes.confirmar", alvo: user }, type: 2, emoji: client.emoji(10), data: "1" },
        { id: "user_profile_about", name: { tls: "menu.botoes.cancelar", alvo: user }, type: 3, emoji: client.emoji(0), data: "0" }
    ], interaction)
