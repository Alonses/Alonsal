...
module.exports = async ({ client, user, interaction }) => {
    ...
    const row = client.create_buttons([
        { id: "misc_notify_button", name: { tls: "menu.botoes.ativar", alvo: user }, type: 0, emoji: client.emoji(20), data: `1|${interaction.guild.id}.${dados.lang}` },
        { id: "misc_notify_button", name: { tls: "menu.botoes.ativar_anunciando", alvo: user }, type: 2, emoji: client.defaultEmoji("channel"), data: `2|${interaction.guild.id}.${dados.lang}` },
