module.exports = async ({ client, user, interaction }) => {
    ...
    const row = client.create_buttons([
        { id: "report_auto", name: { tls: "menu.botoes.confirmar" }, type: 2, emoji: client.emoji(10), data: 1 },
        { id: "report_auto", name: { tls: "menu.botoes.cancelar" }, type: 3, emoji: client.emoji(0), data: 0 }
    ], interaction, user)
