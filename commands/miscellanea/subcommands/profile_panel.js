module.exports = async ({ client, user, interaction }) => {
    ...
    const botoes = [{ id: "misc_profile_about", name: { tls: "menu.botoes.customizar_informacoes", alvo: user }, type: 1, emoji: client.defaultEmoji("tools"), data: "1" }]

    // Botão para remover o "Sobre mim" caso o usuário tenha escrito algo
    if (user.profile.about)
        botoes.push({ id: "misc_profile_about", name: { tls: "menu.botoes.remover_sobre", alvo: user }, type: 1, emoji: client.emoji(0), data: "0" })
